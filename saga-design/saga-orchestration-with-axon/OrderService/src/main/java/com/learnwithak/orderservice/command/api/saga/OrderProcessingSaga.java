package com.learnwithak.orderservice.command.api.saga;
...
public class OrderProcessingSaga {
    public static final Logger LOGGER = LoggerFactory.getLogger(OrderProcessingSaga.class);
    @Autowired
    ...
    private void handle(PaymentProcessedEvent event) {
        LOGGER.info("PaymentProcessedEvent in Saga for Order Id : {}",
                event.getOrderId());
        try {
//This code is used to test the negative scenario i.e. payment failure scenario.
           /* if(true)
                throw new Exception();*/
